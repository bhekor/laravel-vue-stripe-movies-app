      ...
      >
        ...
        <div class="block sm:flex md:block lg:flex items-center justify-center">
          <div class="mt-8 sm:m-8 md:m-0 md:mt-8 lg:m-8 text-center">
            ...
            <span class="block text-md text-gray-600 mt-2">Daily</span>
          </div>
          <div class="mt-4 mb-8 sm:m-8 md:m-0 md:mt-4 md:mb-8 lg:m-8 text-center">
            <div class="inline-flex items-center">
              <span class="text-3xl font-medium">$1000</span>
            </div>
            <span class="block text-md text-gray-600 mt-2">Monthly</span>
          </div>
        </div>
        ...
        <a
          class="block flex items-center justify-center bg-gray-200 hover:bg-gray-300 p-8 text-md font-semibold text-gray-800 uppercase mt-16"
          href="#"
        >
          <span
            ><router-link :to="{ name: 'register' }" class="border-transparent"
      ...
      <div class="w-full md:w-1/2 relative z-0 px-8 md:px-0 md:py-16">
        ...
        >
          ...
          >
            <div class="mt-8 sm:m-8 md:m-0 md:mt-8 lg:m-8 text-center">
              <div class="inline-flex items-center">
                <span class="text-3xl font-medium">$3000</span>
              </div>
              <span class="block text-md text-white mt-2">Yearly</span>
            </div>
            Stripe offers everything needed to run an online business at scale. Get in
            touch for details.
          </div>
          ...
          <a
            class="block flex items-center justify-center bg-blue-800 hover:bg-blue-700 p-8 text-md font-semibold text-gray-300 uppercase mt-8"
            href="#"
          >
            <span
              ><router-link :to="{ name: 'register' }" class="border-transparent"
